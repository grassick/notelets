...
/** Props for the NoteUnlockModal component */
interface NoteUnlockModalProps {
    /** Called with the entered password. Should reject if the password is wrong. */
...
/**
 * Modal to unlock a single encrypted note. The password is used only to derive
 * the note's key in memory and is never stored on the device.
 */
export function NoteUnlockModal({ onUnlock, onCancel }: NoteUnlockModalProps) {
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-md p-6" onClick={(e) => e.stopPropagation()}>
                <div className="text-center mb-6">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 mt-2">
                        Enter this note's password to view and edit its contents
                    </p>
                </div>
