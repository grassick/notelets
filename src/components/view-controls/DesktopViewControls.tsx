...
export function DesktopViewControls({
  ...
  const modes: ViewMode[] = ['notes', 'split', 'chat', 'quiz']

  return (
    <div className={`inline-flex ${vertical ? 'flex-col' : 'flex-row'} p-0.5 gap-0.5 bg-gray-100 dark:bg-gray-800 rounded-md items-center justify-center`}>
      {modes.map((mode) => (
        <button
          key={mode}
